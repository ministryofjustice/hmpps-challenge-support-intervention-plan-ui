    ...
    cy.get('.govuk-summary-card')
      ...
      .within(() => {
        cy.findByRole('link', { name: /Change the contributory factor/i })
          ...
          .and('include', 'update-referral/b8dff21f-e96c-4240-aee7-28900dd910f2-factorType#contributoryFactor')
      })
    cy.get('.govuk-summary-card')
      .eq(1)
      .within(() => {
        cy.findByRole('link', { name: /Change the contributory factor/i })
          .should('be.visible')
          .should('have.attr', 'href')
          .and('include', 'update-referral/b8dff21f-e96c-4240-aee7-28900dd910f1-factorType#contributoryFactor-2')
      })
    cy.get('.govuk-summary-card')
      .eq(2)
      .within(() => {
        cy.findByRole('link', { name: /Change the contributory factor/i })
          .should('be.visible')
          .should('have.attr', 'href')
          .and('include', 'update-referral/b8dff21f-e96c-4240-aee7-28900dd910f3-factorType#contributoryFactor-2')
      })
  }
})

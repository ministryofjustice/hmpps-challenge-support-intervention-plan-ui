...
context('test /record-investigation/protective-factors', () => {
  ...
  it('should try out all cases', () => {
    ...
    cy.title().should('equal', 'What are the protective factors for the prisoner? - Record a CSIP investigation - DPS')
  ...
  const navigateToTestPage = () => {
    ...
    cy.visit(`${uuid}/record-investigation/protective-factors`)
  }
  ...
  const validateErrorMessage = () => {
    ...
    cy.title().should(
      'equal',
      'Error: What are the protective factors for the prisoner? - Record a CSIP investigation - DPS',
    )
    cy.findByRole('link', { name: /Enter a description of the prisoner’s protective factors/i })
      .should('be.visible')
      .click()
    ...
    getContinueButton().click()
    cy.findByRole('link', {
      name: /Description of the prisoner’s protective factors must be 4,000 characters or less/i,
    })
      .should('be.visible')
      .click()
    getInputTextbox().should('be.focused')
